...
Public Class fmrUsuario
    ...
    Private Sub limpiar()
        ...
        PictureBox1.BackgroundImage = My.Resources.usuario
    ...
    Private Sub datalistado_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles datalistado.CellClick
        ...
        txtidciudad.Text = datalistado.SelectedCells.Item(8).Value
        txttelefono.Text = datalistado.SelectedCells.Item(9).Value
        txtdireccion.Text = datalistado.SelectedCells.Item(7).Value
        txtemail.Text = datalistado.SelectedCells.Item(10).Value
        ...
        txtlogin.Text = datalistado.SelectedCells.Item(12).Value
        txtpassword.Text = datalistado.SelectedCells.Item(13).Value
        txtfecha_alta.Text = datalistado.SelectedCells.Item(14).Value
        '' cbestado.Text = datalistado.SelectedCells.Item(15).Value
        btnguardar.Visible = False
        ...
        If result = DialogResult.OK Then 'si esta seguro de modificar
            ...
            If Me.ValidateChildren = True And txtidusuario.Text <> "" And txtnombres.Text <> "" And txtapellidos.Text <> "" And txtdni.Text <> "" And txtfecha_nac.Text <> "" And txttelefono.Text <> "" And txtdireccion.Text <> "" And cbosexo.Text <> "" And txtemail.Text <> "" And txtlogin.Text <> "" And txtpassword.Text <> "" Then
                Try
                    ...
                    Else
                        PictureBox1.Image = My.Resources.productos
                        PictureBox1.Image.Save(ms, PictureBox1.Image.RawFormat)
                    End If
    ...
    Private Sub btnbuscar_ciudad_Click(sender As Object, e As EventArgs) Handles btnbuscar_ciudad.Click
        fmrElegirCiudad.txtflag.Text = "2"
        fmrElegirCiudad.ShowDialog()
    End Sub

    Private Sub PictureBox1_DobleclicClick(sender As Object, e As EventArgs) Handles PictureBox1.DoubleClick
...
#Region "validar globos informativos"
...
#Region "mostrar mensaje informativo "
    ...
    ''mensaje con el mouse ttmensaje
    ...
    Private Sub txtnombres_MouseHover(sender As Object, e As EventArgs) Handles txtnombres.MouseHover
        ttmensaje.SetToolTip(txtnombres, "Ingrese el/los Nombre/s del usuario")
        ttmensaje.ToolTipTitle = "Nombre/s"
        ttmensaje.ToolTipIcon = ToolTipIcon.Info
    End Sub
    Private Sub txtapellidos_MouseHover(sender As Object, e As EventArgs) Handles txtapellidos.MouseHover
        ttmensaje.SetToolTip(txtapellidos, "Ingrese el/los Apellido/s del usuario")
        ttmensaje.ToolTipTitle = "Apellido/os"
        ttmensaje.ToolTipIcon = ToolTipIcon.Info
    End Sub
    ...
    Private Sub txtdireccion_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtdireccion.MouseHover
        'mostramos un mensaje informativo
        ttmensaje.SetToolTip(txtdireccion, "Ingrese la dirección del Usuario, barrio, calle y numero")
        ttmensaje.ToolTipTitle = "Dirección"
        ttmensaje.ToolTipIcon = ToolTipIcon.Info
    End Sub

    Private Sub txtdni_MouseHover(sender As Object, e As EventArgs) Handles txtdni.MouseHover
        ttmensaje.SetToolTip(txtdni, "Ingrese DNI del Usuario")
        ttmensaje.ToolTipTitle = "DNI"
        ttmensaje.ToolTipIcon = ToolTipIcon.Info
    End Sub
    Private Sub txtnombre_ciudad_mousehover(sender As Object, e As EventArgs) Handles txtnombre_ciudad.MouseHover
        ttmensaje.SetToolTip(txtnombre_ciudad, "Ingrese Ciudad del Usuario")
        ttmensaje.ToolTipTitle = "Ciudad"
        ttmensaje.ToolTipIcon = ToolTipIcon.Info
    End Sub
    Private Sub txtfecha_nac_mousehover(sender As Object, e As EventArgs) Handles txtfecha_nac.MouseHover
        ttmensaje.SetToolTip(txtfecha_nac, "Ingrese Fecha Nacimiento del Usuario")
        ttmensaje.ToolTipTitle = "Fecha"
        ttmensaje.ToolTipIcon = ToolTipIcon.Info
    End Sub
    Private Sub PictureBox1_mousehover(sender As Object, e As EventArgs) Handles PictureBox1.MouseHover
        ttmensaje.SetToolTip(PictureBox1, "Puede elegir una foto para el Usuario")
        ttmensaje.ToolTipTitle = "Imagen"
        ttmensaje.ToolTipIcon = ToolTipIcon.Info
    End Sub
    Private Sub txtlogin_mousehover(sender As Object, e As EventArgs) Handles txtlogin.MouseHover
        ttmensaje.SetToolTip(txtlogin, "Ingrese un nombre de sesion para el Usuario, dato necesario para el ingreso al sistema")
        ttmensaje.ToolTipTitle = "Login"
        ttmensaje.ToolTipIcon = ToolTipIcon.Info
    End Sub
    Private Sub txtpassword_MouseHover(sender As Object, e As EventArgs) Handles txtpassword.MouseHover
        ttmensaje.SetToolTip(txtlogin, "Ingrese una Contraseña de sesion para el Usuario, dato necesario para el ingreso al sistema")
